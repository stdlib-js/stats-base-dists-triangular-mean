...
```javascript
import mean from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-triangular-mean@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dists-triangular-mean/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/stats-base-dists-triangular-mean/actions/workflows/test.yml?query=branch:v0.2.0
